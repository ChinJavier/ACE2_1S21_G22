    ...
    function N25(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(http, router) {
          _classCallCheck2(this, AuthService);

          this.http = http;
          this.router = router;
          this._baseURL = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API_URL;
          this._user = {};
        }

        _createClass2(AuthService, [{
          key: "login",
          value: function login(username, password) {
            ...
            return this.http.post("".concat(this._baseURL, "auth"), body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
              _this2._user = res;
              localStorage.setItem('id', _this2._user.uid);
              localStorage.setItem('username', _this2._user.username);
              return true;
          ...
          value: function signup(username, password) {
            ...
            return this.http.post("".concat(this._baseURL, "auth/new"), body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (res) {
              _this3._user = res;
              localStorage.setItem('id', _this3._user.uid);
              localStorage.setItem('username', _this3._user.username);
              return true;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (error) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(false);
            }));
...
//# sourceMappingURL=default~auth-auth-module~dashboard-dashboard-module-es5.js.map